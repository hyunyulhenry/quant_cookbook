...
## 1    294870 HDC현대산업개발     0.1811         0.2167
## 2    097230      한진중공업     0.1228         0.7292
## 3    097520        엠씨넥스     0.1449         0.6846
## 4    091700          파트론     0.1646         0.2802
## 5    036830  솔브레인홀딩스     0.3525         0.2160
## 6    066700    테라젠이텍스     0.1379         0.3543
## 7    044340          위닉스     0.1272         0.3255
## 8    053610          프로텍     0.1910         0.2352
## 9    047310      파워로직스     0.1512         0.2666
## 10   035890        서희건설     0.1604         0.2061
## 11   031330    에스에이엠티     0.1762         0.1988
## 12   002170        삼양통상     0.2753         0.1780
## 13   083450             GST     0.1474         0.2246
## 14   054920        한컴위드     0.1701         0.2367
## 15   065710        서호전기     0.1571         0.2550
## 16   004650      창해에탄올     0.1684         0.2673
## 17   007720    대명소노시즌     1.1929         0.4021
## 18   057540      옴니시스템     0.2122         0.2795
## 19   056360          코위버     0.2005         0.2021
## 20   225190      삼양옵틱스     0.1806         0.4109
## 21   198080          엔피디     0.1417         0.3047
## 22   084670        동양고속     0.3010         0.2724
## 23   124560      태웅로직스     0.1358         0.3212
## 24   032940            원익     0.3475         0.3740
## 25   003780        진양산업     0.1513         0.2238
## 26   032750            삼진     0.2440         0.1954
## 27   005670          푸드웰     0.4272         0.4751
## 28   014100        메디앙스     0.5230         0.4649
## 29   083470      이엠앤아이     0.6918         9.5517
## 30   010640        진양폴리     0.2088         0.2803
```
...
국내 종목들의 PBR 히스토그램을 그려보면 오른쪽으로 꼬리가 매우 긴 분포를 보이고 있습니다. 이는 PBR이 무려 567.71인 이상치 데이터가 있기 때문입니다. 이처럼 모든 팩터 지표에는 극단치 데이터가 있기 마련이며, 이를 처리하는 방법을 알아보겠습니다.
...
## 123    042670 두산인프라코어 0.06 0.47  0.46
## 178    006120   SK디스커버리 0.08 0.53  1.76
## 222    018670         SK가스 0.10 0.56  0.32
## 308    097520       엠씨넥스 0.38 2.70  0.60
## 373    003070   코오롱글로벌 0.10 0.95  0.90
## 413    053210   스카이라이프 0.08 0.61 -0.03
## 427    036830 솔브레인홀딩스 0.14 0.49  0.25
## 491    084690     대상홀딩스 0.06 0.28  0.37
## 550    053610         프로텍 0.18 1.45  0.55
## 602    049070         인탑스 0.07 0.54  0.23
## 636    001390       KG케미칼 0.07 0.18  0.57
## 698    101160         월덱스 0.22 2.67  1.21
## 766    248170       샘표식품 0.17 1.23  0.33
## 821    012700       리드코프 0.11 0.52  0.13
## 847    089470      HDC현대EP 0.05 0.59  0.10
## 857    104460 디와이피엔에프 0.31 2.61  0.65
## 1015   083930         아바코 0.15 0.95  0.45
## 1054   054210         이랜텍 0.07 0.76 -0.02
## 1061   082850     우리바이오 0.04 1.00  2.00
## 1088   079960     동양이엔피 0.11 0.59  0.36
## 1136   050760     에스폴리텍 0.19 2.07  0.87
## 1339   088130       동아엘텍 0.06 0.46  0.15
## 1371   015230       대창단조 0.08 0.47  0.07
## 1551   002870       신풍제지 0.28 1.16  0.71
## 1716   089850     유비벨록스 0.03 0.30  0.06
## 1744   003780       진양산업 0.17 1.35  0.25
## 1749   060540     에스에이티 0.10 0.66  0.10
## 1779   009180 한솔로지스틱스 0.13 1.05  0.35
## 1936   037400       우리조명 0.01 0.24  0.62
## 2084   007530       영신금속 0.14 0.58 -0.01
```
...
## [1,] 0.124 0.235 0.138 8.886 0.935 3.428 0.465  0.366
##      ret_6m ret_12m
## [1,]  0.853   0.478
```
