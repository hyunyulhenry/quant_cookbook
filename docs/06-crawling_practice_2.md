...
```
## # A tibble: 6 x 6
##   `20170605` `46040` `46360` `45720` `45940` `151988`
##        <dbl>   <dbl>   <dbl>   <dbl>   <dbl>    <dbl>
## 1   20170607   46500   46500   45240   45300   274588
## 2   20170608   45000   45580   45000   45160   279575
## 3   20170609   45680   46440   45600   46100   234657
## 4   20170612   45420   45600   45140   45380   219086
## 5   20170613   45140   45620   45140   45400   172498
## 6   20170614   45800   46060   45240   45360   203334
```
...
```
##      PER      PBR      PCR      PSR 
## 6.215846 1.101173 4.069989 1.119159
```
...
```
##      PER      PBR      PCR      PSR 
## 6.216075 1.136461 4.070139 1.119200
```
...
Table: (\#tab:unnamed-chunk-41)두 사이트의 가치지표 비교
                  ...
                  PER    PBR    PCR    PSR
--------------  -----  -----  -----  -----
Company Guide    6.22   1.10   4.07   1.12
야후 파이낸스    6.22   1.14   4.07   1.12
