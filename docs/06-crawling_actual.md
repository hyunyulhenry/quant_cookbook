...
```
## [1] "20181126|42150|42800|42100|42600|6613009" 
## [2] "20181127|42900|43100|42500|43050|8367091" 
## [3] "20181128|42800|43200|42750|43150|6943099" 
## [4] "20181129|43850|43850|42900|43150|8473511" 
## [5] "20181130|43450|44000|41750|41850|19775519"
## [6] "20181203|42750|43400|42400|43250|12110702"
```
...
```
## # A tibble: 6 x 6
##   `20181126` `42150` `42800` `42100` `42600` `6613009`
##        <dbl>   <dbl>   <dbl>   <dbl>   <dbl>     <dbl>
## 1   20181127   42900   43100   42500   43050   8367091
## 2   20181128   42800   43200   42750   43150   6943099
## 3   20181129   43850   43850   42900   43150   8473511
## 4   20181130   43450   44000   41750   41850  19775519
## 5   20181203   42750   43400   42400   43250  12110702
## 6   20181204   42650   42900   41900   42150  14347746
```
...
종목수를 확인해보면 83064 개가 확인되며, 이 중 stock 열이 빈 종목은 거래소에 상장되지 않은 종목입니다. 따라서 해당 데이터는 삭제하여 거래소 상장 종목만을 남긴 후, csv 파일로 저장하도록 합니다.
...
## 1  00390860         MP그룹     065150        K
## 2  00235147         에스모     073070        K
## 3  00235147         에스모     073070        K
## 4  00151863 센트럴인사이트     012600        Y
## 5  00976615           틸론     217880        N
## 6  00976615           틸론     217880        N
##                                                        report_nm
## 1 기타시장안내(코스닥시장위원회 개최 결과 및 심의속개 결정 안내)
## 2                    주권매매거래정지기간변경(상장폐지사유 발생)
## 3                기타시장안내(코스닥시장위원회 심의결과 등 안내)
## 4                                     [기재정정]주주총회소집결의
## 5                         소송등의판결ㆍ결정(일정금액이상의청구)
## 6               [기재정정]소송등의제기ㆍ신청(일정금액이상의청구)
##         rcept_no         flr_nm rcept_dt rm
## 1 20201203900523 코스닥시장본부 20201203 코
## 2 20201203900521 코스닥시장본부 20201203 코
## 3 20201203900522 코스닥시장본부 20201203 코
## 4 20201203800518 센트럴인사이트 20201203 유
## 5 20201203600505           틸론 20201203 넥
## 6 20201203600510           틸론 20201203 넥
```
...
##                                report_nm       rcept_no
## 1 임원ㆍ주요주주특정증권등소유상황보고서 20201203000103
## 2                 기타경영사항(자율공시) 20201201800263
## 3                 기타경영사항(자율공시) 20201201800261
## 4 동일인등출자계열회사와의상품ㆍ용역거래 20201130001711
## 5                 특수관계인과의보험거래 20201130001667
## 6                 특수관계인과의보험거래 20201130001661
##     flr_nm rcept_dt rm
## 1     최철 20201203   
## 2 삼성전자 20201201 유
## 3 삼성전자 20201201 유
...
```
## [1] "http://dart.fss.or.kr/dsaf001/main.do?rcpNo=20201203000103"
```
