...
3. 일부 페이지가 크롤러의 접근을 막음에 따라 user_agent() 함수를 사용해 크롤링이 가능해지게 하였습니다. 
4. 많은 문의가 있었던 DART 크롤링에 대한 내용을 추가했습니다.
5. 포트폴리오 구성 부분에 실무에서 많이 사용되는 인덱스 포트폴리오 및 인핸스드 인덱스 포트폴리오 구성 방법을 추가하였습니다.
6. ggplot2 패키지의 기본적인 사용법을 추가하였습니다.
7. 일부 코드를 수정하여 더욱 데이터 처리를 쉽게 하거나, 종목 선택을 강건하게 하였습니다.
