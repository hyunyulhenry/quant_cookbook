...
```
##  [1]  1.459e-01  7.925e-18 -9.014e-18 -3.070e-18
##  [5] -2.988e-17  7.882e-01  7.619e-19  2.245e-18
##  [9]  7.361e-20  6.586e-02
```
...
## 0.1459 0.0000 0.0000 0.0000 0.0000 0.7882 0.0000 0.0000 
##    GLD    DBC 
## 0.0000 0.0659
```
...
```
##  [1]  1.459e-01 -5.371e-18  0.000e+00  6.482e-19
##  [5] -4.737e-18  7.882e-01  1.348e-18 -2.208e-18
##  [9]  0.000e+00  6.586e-02
```
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 0.1141 0.1000 0.0759 0.0500 0.2000 0.2000 0.0500 0.0500 
##    GLD    DBC 
## 0.0800 0.0800
```
...
## 18.9346  0.5392  3.9430  0.0000 25.4107 39.0109  2.4065 
##     RWX     GLD     DBC 
##  0.0000  8.0173 11.8710
```
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 0.1719 0.0049 0.0358 0.0000 0.2307 0.3542 0.0219 0.0000 
##    GLD    DBC 
## 0.0728 0.1078
```
...
```
##  [1] 0.1719 0.0049 0.0358 0.0000 0.2307 0.3542 0.0219
##  [8] 0.0000 0.0728 0.1078
```
...
주식과 채권이 가지는 위험기여도는 각각 97.6%, 2.4%로서 투자 비중인 60%, 40%와는 전혀 다른 위험 비중을 보입니다. 즉, 주식이 포트폴리오 위험의 대부분을 차지하고 있습니다.
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 0.0607 0.0466 0.0563 0.0369 0.1746 0.3704 0.0394 0.0507 
##    GLD    DBC 
## 0.0875 0.0769
```
...
```
##  [1] 0.09995 0.10000 0.09993 0.09999 0.10003 0.10002
##  [7] 0.10003 0.09993 0.10007 0.10006
```
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 0.0852 0.0665 0.0779 0.0527 0.1823 0.3919 0.0196 0.0251 
##    GLD    DBC 
## 0.0548 0.0441
```
...
```
##  [1] 0.15004 0.14994 0.15003 0.15011 0.10000 0.09996
##  [7] 0.04993 0.04994 0.05003 0.05002
```
