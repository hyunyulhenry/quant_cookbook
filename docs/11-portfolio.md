...
```
##  [1]  1.427e-01  4.987e-18  1.184e-17 -7.502e-19
##  [5] -8.242e-17  7.924e-01 -4.430e-18  2.472e-18
##  [9] -9.055e-18  6.495e-02
```
...
```
##  [1]  1.427e-01 -5.943e-19  0.000e+00  4.852e-19
##  [5]  1.434e-17  7.924e-01  2.258e-18 -5.797e-19
##  [9] -5.030e-19  6.495e-02
```
...
## 0.104 0.100 0.086 0.050 0.200 0.200 0.050 0.050 0.080 
##   DBC 
## 0.080
```
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 16.918  1.288  4.649  0.000 26.177 37.986  2.858  0.000 
##    GLD    DBC 
##  7.882 11.965
```
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 0.1542 0.0117 0.0424 0.0000 0.2386 0.3462 0.0260 0.0000 
##    GLD    DBC 
## 0.0718 0.1091
```
...
```
##  [1] 0.1542 0.0117 0.0424 0.0000 0.2386 0.3462 0.0260
##  [8] 0.0000 0.0718 0.1091
```
...
주식과 채권이 가지는 위험기여도는 각각 97.59%, 2.41%로서 투자 비중인 60%, 40%와는 전혀 다른 위험 비중을 보입니다. 즉, 주식이 포트폴리오 위험의 대부분을 차지하고 있습니다.
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 0.0600 0.0465 0.0565 0.0371 0.1747 0.3721 0.0395 0.0505 
##    GLD    DBC 
## 0.0868 0.0763
```
...
```
##  [1] 0.09996 0.10006 0.09998 0.10008 0.09990 0.09991
##  [7] 0.10011 0.10002 0.09997 0.10001
```
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 0.0843 0.0663 0.0781 0.0529 0.1822 0.3935 0.0197 0.0250 
##    GLD    DBC 
## 0.0543 0.0437
```
...
```
##  [1] 0.14995 0.14992 0.15004 0.15004 0.09996 0.09997
##  [7] 0.05007 0.04997 0.05005 0.05002
```
