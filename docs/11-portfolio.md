...
```
##  [1]  1.426e-01  2.832e-17  1.482e-18 -4.522e-18
##  [5] -1.055e-17  7.924e-01  4.053e-18  1.684e-18
##  [9] -3.829e-18  6.497e-02
```
...
## 0.1426 0.0000 0.0000 0.0000 0.0000 0.7924 0.0000 0.0000 
##    GLD    DBC 
## 0.0000 0.0650
```
...
```
##  [1]  1.426e-01  2.655e-18 -2.168e-19  5.200e-18
##  [5] -9.803e-18  7.924e-01 -2.418e-18 -5.533e-19
##  [9]  0.000e+00  6.497e-02
```
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 16.883  1.310  4.654  0.000 26.168 38.065  2.866  0.000 
##    GLD    DBC 
##  7.865 11.982
```
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 0.1538 0.0119 0.0424 0.0000 0.2383 0.3467 0.0261 0.0000 
##    GLD    DBC 
## 0.0716 0.1091
```
...
```
##  [1] 0.1538 0.0119 0.0424 0.0000 0.2383 0.3467 0.0261
...
```
##  [1] 0.09996 0.10002 0.09995 0.10008 0.09992 0.09993
##  [7] 0.10009 0.10001 0.10004 0.09999
```
...
```
##    SPY    IEV    EWJ    EEM    TLT    IEF    IYR    RWX 
## 0.0843 0.0663 0.0781 0.0529 0.1822 0.3936 0.0197 0.0250 
##    GLD    DBC 
## 0.0542 0.0437
```
...
```
##  [1] 0.14998 0.14989 0.15003 0.15007 0.10000 0.10000
##  [7] 0.05007 0.04997 0.04999 0.05002
```
