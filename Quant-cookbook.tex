...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{url =}\StringTok{ 'https://finance.yahoo.com/quote/005930.KS/key-statistics?p=005930.KS'}
\NormalTok{data =}\StringTok{ }\KeywordTok{GET}\NormalTok{(url)}

\NormalTok{price =}\StringTok{ }\KeywordTok{read_html}\NormalTok{(data) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{html_node}\NormalTok{(}\DataTypeTok{xpath =} \StringTok{'//*[@id="quote-header-info"]/div[3]/div/div/span[1]'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{html_text}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{str_replace_all}\NormalTok{(}\StringTok{','}\NormalTok{, }\StringTok{''}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{as.numeric}\NormalTok{()}
...
\StringTok{  }\KeywordTok{html_node}\NormalTok{(}\DataTypeTok{xpath =} \StringTok{'//*[@id="Col1-0-KeyStatistics-Proxy"]/section/div[2]/div[2]/div/div[2]/table/tbody/tr[3]/td[2]'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{html_text}\NormalTok{() }
