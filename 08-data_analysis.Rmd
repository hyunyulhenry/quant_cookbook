...
saveWidget(m, paste0(getwd(),'/data/dygraph.html'), selfcontained = FALSE)
webshot(paste0(getwd(),'/data/dygraph.html'), 
        delay = 1, file = 'images/dygraph.png')
```
...
saveWidget(m, paste0(getwd(),'/data/highcharter.html'), selfcontained = FALSE)
webshot(paste0(getwd(),'/data/highcharter.html'), 
        delay = 1, file = 'images/highcharter.png')
```
...
saveWidget(p, paste0(getwd(),'/data/ggplotly.html'), selfcontained = FALSE)
webshot(paste0(getwd(),'/data/ggplotly.html'), file = 'images/ggplotly.png')
```

```{r echo = FALSE}
knitr::include_graphics('images/ggplotly.png')
```
...
saveWidget(p, paste0(getwd(),'/data/plotly.html'), selfcontained = FALSE)
webshot(paste0(getwd(),'/data/plotly.html'), file = 'images/plotly.png')
```
