...
```{r fig.cap='아스키 코드 표', fig.align='center', echo = FALSE}
...
```{r fig.cap='웹페이지에서 사용되는 인코딩 비율', fig.align='center', echo = FALSE}
...
```{r fig.cap='인코딩 설정 항목', fig.align='center', out.width = '100%', echo = FALSE}
...
```{r fig.cap='HTML 기본 구조', fig.align='center', out.width = '50%', echo = FALSE}
...
```{r fig.cap='HTML 구성 요소 분석', fig.align='center', out.width = '70%', echo = FALSE}
...
```{r fig.cap='h 태그와 p 태그 예제', fig.align='center', out.width = '50%', echo = FALSE}
...
```{r fig.cap='리스트 관련 태그 예제', fig.align='center', out.width = '50%', echo = FALSE}
...
```{r fig.cap='table 태그 예제', fig.align='center', out.width = '50%', echo = FALSE}
...
```{r fig.cap='a 태그와 src 태그 예제', fig.align='center', out.width = '50%', echo = FALSE}
...
```{r fig.cap='div 태그 예제', fig.align='center', out.width = '50%', echo = FALSE}
...
```{r fig.cap='css 예제', fig.align='center', out.width = '50%', echo = FALSE}
...
```{r fig.cap='class 예제', fig.align='center', out.width = '50%', echo = FALSE}
...
```{r fig.cap='id 예제', fig.align='center', out.width = '50%', echo = FALSE}
