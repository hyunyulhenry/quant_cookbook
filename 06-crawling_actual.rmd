...
```{r fig.cap='오픈API 회원가입', echo = FALSE}
knitr::include_graphics('images/dart_api.png')
```

[계정신청]을 통해 계정을 만들고 이메일을 통해 이용자 등록을 한 후 로그인을 합니다. 그 후 [개인용 오픈API 인증키 신청]을 통해 API KEY를 발급받습니다.

```{r fig.cap='API KEY 발급', echo = FALSE}
knitr::include_graphics('images/dart_api_private.png')
```

```{r fig.cap='API Key 발급완료', echo = FALSE}
knitr::include_graphics('images/dart_api_private2.png')
```
...
```{r fig.cap='검색API 샘플', echo = FALSE}
knitr::include_graphics('images/dart_api_sample.png')
```
...
```{r fig.cap='사업보고서 검색하기', echo = FALSE}
knitr::include_graphics('images/dart_api_search.png')
```

회사명은 삼성전자, 기간은 전체, 정기공시의 사업보고서 항목을 체크한 후 검색을 누르면 연말 사업보고서가 검색됩니다. 이 중 최근 보고서를 클릭합니다.

```{r fig.cap='사업보고서 확인하기', echo = FALSE}
knitr::include_graphics('images/dart_api_report.png')
```
...
```{r fig.cap='문서번호 검색하기', echo = FALSE}
knitr::include_graphics('images/dart_api_dcm.png')
```
...
```{r fig.cap='엑셀 다운로드 과정 확인하기', echo = FALSE}
knitr::include_graphics('images/dart_api_excel.png')
```
...
```{r fig.cap='엑셀 데이터 확인하기', echo = FALSE}
knitr::include_graphics('images/dart_api_excel_down.png')
```
...
```{r fig.cap='엑셀 리스트 확인하기', echo = FALSE}
knitr::include_graphics('images/dart_api_excel_list.png')
```
