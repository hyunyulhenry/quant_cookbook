...
```{r fig.cap='클라이언트와 서버 간의 요청/응답 과정', fig.align='center', echo = FALSE}
...
```{r fig.cap='한경 컨센서스 기업 REPORT 페이지', fig.align='center', out.width = '100%', echo = FALSE}
...
```{r fig.cap='쿼리 추가로 인한 url의 변경', fig.align='center', out.width = '100%', echo = FALSE}
...
```{r fig.cap='상장공시시스템의 상장종목현황 메뉴', fig.align='center', echo = FALSE}
...
```{r fig.cap='크롬 개발자도구의 Network 화면', fig.align='center', echo = FALSE}
...
```{r fig.cap='POST 방식의 서버 요청 내역', fig.align='center', echo = FALSE}
...
```{r fig.cap='실시간 속보의 제목 부분 html', fig.align='center', out.width = '100%', echo = FALSE}
...
```{r fig.cap='오늘의공시 확인하기', fig.align='center', echo = FALSE}
...
```{r fig.cap='POST 방식의 데이터 요청', fig.align='center', out.width = '100%', echo = FALSE}
...
```{r fig.cap='페이지 네비게이션', fig.align='center', out.width = '70%', echo = FALSE}
